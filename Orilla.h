...
/**
  CLASE: Orilla
  INTENCIÓN: Estoy modelando una orilla que ES un Lugar con un nombre, en el cual puede haber individuos, y conoce 2 vecinos (otros lugares). Como ES un Lugar, se le puede pedir:
...
class Orilla : public Lugar
{
  public:
  /**
  Constructor: Construye una orilla que ES un lugar con un nombre, en el que pueden haber individuos y que puede conocer 2 vecinos (otros lugares). Como está recien fabricado, no hay individuos en el y no conoce ningún vecino.
  */
